...
<div class="main-container-header" id="home">
    ...
    <header class="header">
        ...
        <ul class="menu">
            ...
            <li><a href="#schedule">Atividades</a></li>
...
<section class="main-container bg-white" id="about">
    <div class="content p-100">
        <div class="flex">
            <article class="flex-2">
                ...
                <p>Conheça nosso barco tumbira e nossos serviços de lazer através de pesca esportiva!
                    ...
                    que é realizada com fins de diversão e se tornar o esporte mais saudável e com menor impacto para ao meio ambiente.</p>
            </article>
            <article class="flex-2">
        ...
        <div class="flex m-20">
            ...
            <div class="flex-8">
                <a href="images/interior-do-banheiro2.jpeg" data-lightbox="set" data-title="My caption">
                    <img class="example-image" src="images/interior-do-banheiro2.jpeg" alt="" />
                </a>
            </div>
            <div class="flex-8">
                <a href="images/interior-do-banheiro.jpeg" data-lightbox="set" data-title="My caption">
                    <img class="example-image" src="images/interior-do-banheiro.jpeg" alt="" />
                </a>
            </div>
            <div class="flex-8">
                <a href="images/roll.jpeg" data-lightbox="set" data-title="My caption">
                    <img class="example-image" src="images/roll.jpeg" alt="" />
                </a>
            </div>
            <div class="flex-8">
                <a href="images/roll1.jpeg" data-lightbox="set" data-title="My caption">
                    <img class="example-image" src="images/roll1.jpeg" alt="" />
                </a>
            </div>
            <div class="flex-8">
                <a href="images/roll3.jpeg" data-lightbox="set" data-title="My caption">
                    <img class="example-image" src="images/roll3.jpeg" alt="" />
                </a>
            </div>
        </div>
    </div>
        ...
        <main class="flex">
            <article class="flex-2">
                <div class="speakers mb-60">
                    <div class="avatar">
                        <img src="images/barcelos.jpeg" alt="">
                    </div>
                    <div class="bio">
                        <h1>Barcelos</h1>
    ...
    <div class="content">
        ...
        <div class="flex">
            <article class="flex-2 mb-30">
                ...
                <p class="email_contato">contato@pescaria.com.br</p>
                <p class="p_contato">Por telefone</p>
                <p class="email_contato">(92) 99876-5432</p>
            ...
            <article class="flex-2">
                ...
                <textarea name="assunto " id="assunto" rows="5"
                          placeholder="Digite suas informações aqui..."></textarea>
